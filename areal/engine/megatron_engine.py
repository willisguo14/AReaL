...
class MegatronEngine(TrainEngine):
    ...
    def clear_batches(self, shard_ids: list[str] | None = None) -> None:
        ...
        Non-head tensor-parallel ranks receive no positional arguments when
        this RPC is sent with ``broadcast=False``; they do not localize the
        RTensor payload and can safely no-op.
        """
